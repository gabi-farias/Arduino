...
void texto_serial(String etapa, int duracao_etapa){
...
void texto_lcd(String etapa, int duracao_etapa){
    lcd.clear();
    lcd.setCursor(2,0);
    lcd.print(etapa);
    lcd.setCursor(10,0);
...
void liga_motor(int duracao_etapa, int n){
...
void enxague(int duracao_etapa)
{
  estado = 3;
  acende_LED_ETAPAS(2); 
